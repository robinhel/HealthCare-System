...
// Separata listor för olika roller.
...
while (Running)
{
    ...
    else
    {
        ...
        if (activeUser.Role == UserRole.Patient)
        {
            ...
            Console.WriteLine("[2] - Requst doctors appointment"); // Robin
            Console.WriteLine("[3] - Show schedule"); // Robin
            ...
            switch (Console.ReadLine())
            {
                ...
                case "2":
                    ...
                    {
                        Console.WriteLine($"Doctor Index:{i} Dr.{doctors[i].Username}.");
                    }

                    int BookedDrIndex = Convert.ToInt32(Console.ReadLine());
                    Console.WriteLine("Enter index of Doctor to book.");

                    bookingSystem.ShowAvailableTimes(doctors[BookedDrIndex]);
        ...
        if (activeUser.Role == UserRole.Doctor)
        {
            ...
            Console.WriteLine("[3] - Accept Requested Appointment"); //Robin
            Console.WriteLine("[4]");
